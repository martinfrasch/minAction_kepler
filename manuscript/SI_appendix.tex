...
\title{Supporting Information for: From Physiology to Physics: Minimum-Action Learning as a Vertically Organizing Principle for AI, Brains, and Physical Law}

\author{Martin G. Frasch}
\affil{Institute on Human Development and Disability, University of Washington, Seattle, WA, USA}
\affil{Health Stream Analytics, LLC, Seattle, WA, USA}

\correspondingauthor{E-mail: mfrasch@uw.edu, martin@healthstreamanalytics.com}
...
\hline
\multicolumn{5}{l}{\small $^*$With biased gate initialization or Noetherian post-selection.} \\
\end{tabular}
\end{table}
...
\subsubsection{S4F. Basis Library Sensitivity}
